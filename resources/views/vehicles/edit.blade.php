...
<div class="container">
    ...
    <form method="POST" action="{{ route('vehicles.update', $vehicle->id) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="vehiclePlateNum" class="form-control @error('vehiclePlateNum') is-invalid @enderror" name="vehiclePlateNum" value="{{ old('vehiclePlateNum', $vehicle->vehiclePlateNum) }}" readonly>
